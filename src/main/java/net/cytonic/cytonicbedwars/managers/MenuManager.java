...
public class MenuManager {
    ...
    public Menu getSpectatorSelectorMenu() {
        ...
        plugin.getGameManager().getAlivePlayers().forEach(uuid -> {
            ...
            MenuItem item = ItemBuilder.of(head).buildItem((player, event) -> {
    ...
    public Menu getSpectatorSpeedMenu() {
        ...
        menu.setItem(11, ItemBuilder.of(tenthSpeed).buildItem((player, event) -> {
            player.setFlySpeed(0.01f);
            player.closeInventory();
            player.sendMessage(ChatColor.GREEN + "Your flight speed is now " + ChatColor.GOLD + "0.1x");
        }));
        ...
        menu.setItem(12, ItemBuilder.of(halfSpeed).buildItem((player, event) -> {
            player.setFlySpeed(0.05f);
            player.closeInventory();
            player.sendMessage(ChatColor.GREEN + "Your flight speed is now " + ChatColor.GOLD + "0.5x");
        }));
        ...
        menu.setItem(13, ItemBuilder.of(normalSpeed).buildItem((player, event) -> {
            player.setFlySpeed(0.1f);
            player.closeInventory();
            player.sendMessage(ChatColor.GREEN + "Your flight speed is now " + ChatColor.GOLD + "1x");
        ...
        menu.setItem(14, ItemBuilder.of(x2Speed).buildItem((player, event) -> {
            player.setFlySpeed(0.2f);
            player.closeInventory();
            player.sendMessage(ChatColor.GREEN + "Your flight speed is now " + ChatColor.GOLD + "2x");
        }));
        ...
        menu.setItem(15, ItemBuilder.of(x5Speed).buildItem((player, event) -> {
            player.setFlySpeed(0.5f);
            player.closeInventory();
            player.sendMessage(ChatColor.GREEN + "Your flight speed is now " + ChatColor.GOLD + "5x");
        }));
