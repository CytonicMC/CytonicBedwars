...
//                    topLine(),
//                    Msg.mm(""),
//                    Msg.mm("Map: <green>" + BedwarsConfig.mapName),
//                    Msg.mm("Players: <green>" + Cytosis.getOnlinePlayers().size() + "/" + BedwarsConfig.maxPlayers),
//                    Msg.mm(""),
//                    Msg.mm("Waiting..."),
//                    Msg.mm(""),
//                    Msg.mm("Mode: <green>" + BedwarsConfig.mode),
...
//                    BedwarsConfig.teams.values().forEach(team -> {
