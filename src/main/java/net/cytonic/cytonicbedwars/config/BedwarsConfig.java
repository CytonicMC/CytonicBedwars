...
public record BedwarsConfig(
    ...
    public static final Codec<BedwarsConfig> CODEC = StructCodec.struct(
        "mode", BedwarsMode.CODEC, BedwarsConfig::mode,
        BedwarsConfig::new
    );
...
//            }
//        });
//        node.node("generators_wait_time_ticks").childrenMap().forEach(
//            (key, value) -> generatorsWaitTimeTicks.put(GeneratorType.valueOf(String.valueOf(key).toUpperCase()),
//                value.getInt()));
//        node.node("generators_item_limit").childrenMap().forEach(
//            (key, value) -> generatorsItemLimit.put(GeneratorType.valueOf(String.valueOf(key).toUpperCase()),
//                value.getInt()));
...
//        });
//        try {
//            itemShopSkin = new PlayerSkin(node.node("npc_skins", "item_shop", "textures").getString(),
//                node.node("npc_skins", "item_shop", "signature").getString());
//            teamShopSkin = new PlayerSkin(node.node("npc_skins", "team_shop", "textures").getString(),
//                node.node("npc_skins", "team_shop", "signature").getString());
//        } catch (Exception e) {
