...
docker run -e WORLD_NAME=farm -e WORLD_TYPE=bedwars_map_solos -e GAME_TYPE=solos -e OTEL_PORT=4317 -e OTEL_HOSTNAME="$OTEL_HOSTNAME" -d -t --network host --name cytonicbedwars ghcr.io/cytonicmc/cytonicbedwars:latest
